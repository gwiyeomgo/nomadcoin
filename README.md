...
새 블록 추가시 message
1. 새 블록이 만들어 졌을 때 새 블록을 호출하고 모든 peer 확인하고 보낸다

node 에서 채굴하면 다른 node에게 알려주는 네트워크가 생김


**문제
포트 3000 에서 블로을 채굴하면 3000 의  node 가
mempool 을 비워 버린다
4000 의 mempool 은 남아있나?
****
# 12.31
3000 이 2000 에게 업그레이드를 요청하고 받으면
4000 에게 새로운 peer 가 있다고 알리고
